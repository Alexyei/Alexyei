...
### 4. Веб-приложение подбора фильмов (web)
   ...
   В данной работе я реализовал рекомендательную систему для подбора фильмов, а также веб-приложение применяющие её. Для создания рекомендательной системы потребывалось применить высокопроизводительные вычисления. Отличительной особенность данной работы является то, что рекомендательная система, высокопроизводительная обработка данных, и веб-приложение написаны на одном языке программирования - на JavaScript.
   
   Разработанное веб-приложение по сути является платформой для тестирования различных рекомендательных алгоритмов. Оно позволяет:
   - Отслеживать действия пользователя
   - Генерировать данные необходимые алгоритмам
   - Рассчитывать неявные оценки
   - Анализировать эффективность работы рекомендательных алгоритмов
   - Выводить рекомендации пользователям
